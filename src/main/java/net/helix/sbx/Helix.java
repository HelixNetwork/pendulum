...
import net.helix.sbx.network.Node;
import net.helix.sbx.network.TransactionRequester;
import net.helix.sbx.network.UDPReceiver;
import net.helix.sbx.network.impl.TransactionRequesterWorkerImpl;
import net.helix.sbx.network.replicator.Replicator;
import net.helix.sbx.service.TipsSolidifier;
import net.helix.sbx.service.ledger.impl.LedgerServiceImpl;
import net.helix.sbx.service.milestone.impl.*;
import net.helix.sbx.service.snapshot.SnapshotException;
import net.helix.sbx.service.snapshot.impl.LocalSnapshotManagerImpl;
import net.helix.sbx.service.snapshot.impl.SnapshotProviderImpl;
import net.helix.sbx.service.snapshot.impl.SnapshotServiceImpl;
...
import net.helix.sbx.service.transactionpruning.async.AsyncTransactionPruner;
...
public class Helix {
    ...
    public void init() throws Exception {
        ...
        if (configuration.isRevalidate()) {
            tangle.clearColumn(net.helix.sbx.model.persistables.Milestone.class);
            tangle.clearColumn(net.helix.sbx.model.StateDiff.class);
            tangle.clearMetadata(net.helix.sbx.model.persistables.Transaction.class);
        }
    ...
    private void rescanDb() throws Exception {
        ...
        tangle.clearColumn(net.helix.sbx.model.persistables.Address.class);
        tangle.clearColumn(net.helix.sbx.model.persistables.Bundle.class);
        tangle.clearColumn(net.helix.sbx.model.persistables.Approvee.class);
        tangle.clearColumn(net.helix.sbx.model.persistables.BundleNonce.class);
        tangle.clearColumn(net.helix.sbx.model.persistables.Tag.class);
        tangle.clearColumn(net.helix.sbx.model.persistables.Milestone.class);
        tangle.clearColumn(net.helix.sbx.model.StateDiff.class);
        tangle.clearMetadata(net.helix.sbx.model.persistables.Transaction.class);

package net.helix.sbx.network.replicator;

import net.helix.sbx.conf.MainnetConfig;
import net.helix.sbx.conf.TestnetConfig;
import net.helix.sbx.network.Neighbor;
import net.helix.sbx.network.Node;
import net.helix.sbx.network.TCPNeighbor;

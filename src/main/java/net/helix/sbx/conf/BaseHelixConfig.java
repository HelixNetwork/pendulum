...
import net.helix.sbx.utils.HelixUtils;
...
public abstract class BaseHelixConfig implements HelixConfig {
    ...
    public JCommander parseConfigFromArgs(String[] args) throws ParameterException {
        ...
        JCommander jCommander = JCommander.newBuilder()
                ...
                .programName("java -jar sbx-" + SBX.VERSION + ".jar")
                .build();
    ...
    public interface Defaults {
        ...
        //Coo
        String COORDINATOR_ADDRESS = "f147b94cdbec515c6e2fadf49c0b8c170bbf5839bebcd368f05e4fcdeb3a90b4";

package net.helix.sbx.service.transactionpruning.async;
...
import net.helix.sbx.service.transactionpruning.TransactionPrunerJob;
...
public class AsyncTransactionPruner implements TransactionPruner {
     ...
     * {@link net.helix.sbx.conf.BaseHelixConfig#localSnapshotsBasePath} config variable. If the path is relative, it

 ...
 * {@link net.helix.sbx.service.snapshot.LocalSnapshotManager} in connection with local snapshots and eventually other
 * parts of the code.
 */
public interface TransactionPruner {
     ...
     * the {@link TransactionPruner}, the {@link net.helix.sbx.storage.Tangle}, the
     * {@link net.helix.sbx.controllers.TipsViewModel} and the {@link net.helix.sbx.service.snapshot.Snapshot} instances

...
import net.helix.sbx.model.persistables.Milestone;
...
/**
 * Represents a cleanup job for {@link net.helix.sbx.service.transactionpruning.TransactionPruner}s that removes
 ...
 *
 * It is used by the {@link net.helix.sbx.service.snapshot.LocalSnapshotManager} to clean up milestones prior to a
...
public class MilestonePrunerJob extends AbstractTransactionPrunerJob {
     ...
     * {@link net.helix.sbx.service.transactionpruning.TransactionPruner} state file) and restored (after IRI restarts),

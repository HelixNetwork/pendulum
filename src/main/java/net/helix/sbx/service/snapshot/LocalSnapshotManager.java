package net.helix.sbx.service.snapshot;
...
public interface LocalSnapshotManager {
     ...
     * {@link net.helix.sbx.conf.SnapshotConfig#getLocalSnapshotsIntervalSynced()}.
     *
     ...
     * {@link net.helix.sbx.conf.SnapshotConfig#getLocalSnapshotsIntervalUnsynced()} instead.
     *

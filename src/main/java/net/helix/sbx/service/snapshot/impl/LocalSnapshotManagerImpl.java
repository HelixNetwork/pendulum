package net.helix.sbx.service.snapshot.impl;

import net.helix.sbx.conf.SnapshotConfig;
import net.helix.sbx.service.milestone.LatestMilestoneTracker;
import net.helix.sbx.service.snapshot.LocalSnapshotManager;
...
import net.helix.sbx.service.transactionpruning.TransactionPruner;

import net.helix.sbx.utils.thread.ThreadIdentifier;
import net.helix.sbx.utils.thread.ThreadUtils;
...
public class LocalSnapshotManagerImpl implements LocalSnapshotManager {
    /**
     * The interval (in milliseconds) in which we check if a new local {@link net.helix.sbx.service.snapshot.Snapshot} is
     * due.
     */
    ...
    /**
     * Data provider for the relevant {@link net.helix.sbx.service.snapshot.Snapshot} instances.
     */
    private SnapshotProvider snapshotProvider;

    /**
     * Service that contains the logic for generating local {@link net.helix.sbx.service.snapshot.Snapshot}s.
     */
     ...
     *
     * It periodically checks if a new {@link net.helix.sbx.service.snapshot.Snapshot} has to be taken until the
     * {@link Thread} is terminated. If it detects that a {@link net.helix.sbx.service.snapshot.Snapshot} is due it
     * triggers the creation of the {@link net.helix.sbx.service.snapshot.Snapshot} by calling

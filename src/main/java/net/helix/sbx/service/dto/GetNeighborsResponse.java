...
public class GetNeighborsResponse extends AbstractResponse {
     ...
     * </ol>
     * @see {@link net.helix.sbx.service.dto.GetNeighborsResponse.Neighbor}
     */
     ...
     *
     * @param elements {@link net.helix.sbx.network.Neighbor}
     * @return an {@link GetNeighborsResponse} filled all neighbors and their activity.
     */
    public static AbstractResponse create(final List<net.helix.sbx.network.Neighbor> elements) {
        GetNeighborsResponse res = new GetNeighborsResponse();
        res.neighbors = new Neighbor[elements.size()];
        int i = 0;
        for (net.helix.sbx.network.Neighbor n : elements) {
    ...
    static class Neighbor {
         ...
         */
        public static Neighbor createFrom(net.helix.sbx.network.Neighbor n) {

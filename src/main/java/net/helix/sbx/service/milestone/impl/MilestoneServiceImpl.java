...
import net.helix.sbx.service.milestone.MilestoneValidity;
...
public class MilestoneServiceImpl implements MilestoneService {
     ...
     * @return the latest solid milestone that was previously processed by sbx or an empty value if no previously

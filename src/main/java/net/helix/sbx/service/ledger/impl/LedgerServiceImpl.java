...
public class LedgerServiceImpl implements LedgerService {
    ...
    /**
     * Generates the {@link net.helix.sbx.model.StateDiff} that belongs to the given milestone in the database and marks
     ...
     * net.helix.sbx.model.StateDiff} if that is not the case. To do so, it calculates the balance changes, checks if
     ...
     *
     * @param milestone the milestone that shall have its {@link net.helix.sbx.model.StateDiff} generated
     * @return {@code true} if the {@link net.helix.sbx.model.StateDiff} could be generated and {@code false} otherwise
     * @throws LedgerException if anything unexpected happens while generating the {@link net.helix.sbx.model.StateDiff}
     */

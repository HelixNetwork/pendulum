...
public class TransactionViewModel {
    ...
    public static final int SIGNATURE_MESSAGE_FRAGMENT_OFFSET = 0, SIGNATURE_MESSAGE_FRAGMENT_SIZE = 512;
    public static final int ADDRESS_OFFSET = SIGNATURE_MESSAGE_FRAGMENT_OFFSET + SIGNATURE_MESSAGE_FRAGMENT_SIZE, ADDRESS_SIZE = 32;
    public static final int VALUE_OFFSET = ADDRESS_OFFSET + ADDRESS_SIZE, VALUE_SIZE = 8, VALUE_USABLE_SIZE = 8;
    public static final int BUNDLE_NONCE_OFFSET = VALUE_OFFSET + VALUE_SIZE, BUNDLE_NONCE_SIZE = 32;
    public static final int TIMESTAMP_OFFSET = BUNDLE_NONCE_OFFSET  + BUNDLE_NONCE_SIZE, TIMESTAMP_SIZE = 8;
    public static final int CURRENT_INDEX_OFFSET = TIMESTAMP_OFFSET + TIMESTAMP_SIZE, CURRENT_INDEX_SIZE = 8;
    public static final int LAST_INDEX_OFFSET = CURRENT_INDEX_OFFSET + CURRENT_INDEX_SIZE, LAST_INDEX_SIZE = 8;
    public static final int BUNDLE_OFFSET = LAST_INDEX_OFFSET + LAST_INDEX_SIZE, BUNDLE_SIZE = 32;
    public static final int TRUNK_TRANSACTION_OFFSET = BUNDLE_OFFSET + BUNDLE_SIZE, TRUNK_TRANSACTION_SIZE = 32;
    public static final int BRANCH_TRANSACTION_OFFSET = TRUNK_TRANSACTION_OFFSET + TRUNK_TRANSACTION_SIZE, BRANCH_TRANSACTION_SIZE = 32;

    public static final int TAG_OFFSET = BRANCH_TRANSACTION_OFFSET + BRANCH_TRANSACTION_SIZE, TAG_SIZE = 8;
    public static final int ATTACHMENT_TIMESTAMP_OFFSET = TAG_OFFSET + TAG_SIZE, ATTACHMENT_TIMESTAMP_SIZE = 8;
    public static final int ATTACHMENT_TIMESTAMP_LOWER_BOUND_OFFSET = ATTACHMENT_TIMESTAMP_OFFSET + ATTACHMENT_TIMESTAMP_SIZE, ATTACHMENT_TIMESTAMP_LOWER_BOUND_SIZE = 8;

...
public class NomineeTrackerImpl implements NomineeTracker {
    ...
    public NomineeTrackerImpl init(Tangle tangle, LatestMilestoneTracker latestMilestoneTracker, SnapshotProvider snapshotProvider, MilestoneService milestoneService, MilestoneSolidifier milestoneSolidifier, HelixConfig config) {

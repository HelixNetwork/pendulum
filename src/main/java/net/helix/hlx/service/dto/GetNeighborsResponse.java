...
public class GetNeighborsResponse extends AbstractResponse {
     ...
     * </ol>
     * @see {@link net.helix.hlx.service.dto.GetNeighborsResponse.Neighbor}
     */
     ...
     *
     * @param elements {@link net.helix.hlx.network.Neighbor}
     * @return an {@link GetNeighborsResponse} filled all neighbors and their activity.
     */
    public static AbstractResponse create(final List<net.helix.hlx.network.Neighbor> elements) {

...
public interface ProtocolConfig extends Config {
    ...
    interface Descriptions {
        ...
        String P_SELECT_MILESTONE = DescriptionHelper.PROB_OF + "requesting a milestoneTracker transaction from a neighbor. This should be a large since it is imperative that we find milestones to get transactions confirmed";

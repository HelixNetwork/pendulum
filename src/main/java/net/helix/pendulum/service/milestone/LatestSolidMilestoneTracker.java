...
public interface LatestSolidMilestoneTracker {
     ...
     */
    void trackLatestSolidMilestones() throws MilestoneException;

    /**
     * This method starts the background worker that automatically calls {@link #trackLatestSolidMilestones()}

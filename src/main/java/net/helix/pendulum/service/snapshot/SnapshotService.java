...
public interface SnapshotService {
    ...
    SnapshotService init(Tangle tangle, SnapshotProvider snapshotProvider, SpentAddressesService spentAddressesService,
            SpentAddressesProvider spentAddressesProvider, PendulumConfig config);

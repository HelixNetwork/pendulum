...
public class GetNeighborsResponse extends AbstractResponse {
     ...
     * </ol>
     * @see {@link net.helix.pendulum.service.dto.GetNeighborsResponse.Neighbor}
     */
     ...
     *
     * @param elements {@link net.helix.pendulum.network.Neighbor}
     * @return an {@link GetNeighborsResponse} filled all neighbors and their activity.
     */
    public static AbstractResponse create(final List<net.helix.pendulum.network.Neighbor> elements) {
